...
def make_jsons(OUT_DIR, SEASON):
    ...
    constr_standings_progression = api_fetchers.fetch_constr_standings_progression(SEASON, last_completed_round)
    ...
    standings_json_builder.build_and_write(
        OUT_DIR, SEASON, driver_info, constr_info, driver_standings_progression, constr_standings_progression, last_completed_round
    )
